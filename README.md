...
Em **Google Calendar → Configurações → Integrar agenda**, copie a URL do campo
de incorporação e, se desejar, o endereço público da agenda. Cole os valores em
`_config.yml`:

```yaml
google_calendar_embed_url: "https://calendar.google.com/calendar/embed?..."
google_calendar_subscribe_url: "https://calendar.google.com/calendar/..."
```

O primeiro endereço exibe o calendário na página inicial. O segundo ativa o
